sap.ui.define([
		...
		return BaseObject.extend("technovati.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias technovati.model.ListSelector
			 */
			 ...
			 * @return {technovati.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
